...
public void evaluateArithmatics(char op, ref Stack stack){
...
/// <param name="stack">the stack to be used for evaluation</param>
/// <returns>null</returns>
public void output(char op, ref Stack stack){
    switch (op)
    {
...
/// <returns>null</returns>
public void evaluateInput(char op, ref Stack stack, ref bool running){
    switch(op)
    {
        case '&':
...
/// <param name="stack">the stack to be used for evaluation.</param>
/// <returns>null</returns>
public void evaluateStack(char op, ref Stack stack){
    switch (op)
    {
